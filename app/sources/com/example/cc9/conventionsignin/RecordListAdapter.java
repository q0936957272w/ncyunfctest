...
public class RecordListAdapter extends BaseAdapter {
    ...
    private void createAdapterData() {
        try {
            ...
            task.execute(new String[]{"https://web085004.adm.ncyu.edu.tw/conventioncloud/api/record?processId=" + GlobalVars.CurrentProcessId + "&conventionId=" + GlobalVars.CurrentConventionId});
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            holder.Item1.setText(item.getString("ItemText1"));
            holder.Item2.setText(item.getString("ItemText2"));
            holder.Image1.setImageResource(C0008R.drawable.face);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return convertView;
